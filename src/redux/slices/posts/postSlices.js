...
import formDataConsole from '../../../utils/formDataConsole';
// action to redirect
...
export const createPostAction = createAsyncThunk(
	...
	async (post, { rejectWithValue, getState, dispatch }) => {
		console.log(
			'🚀 ~ file: postSlices.js ~ line 11 ~ createPostAction ~ post',
			post
		);
		...
		try {
			...
			formData.append('blogBannerImage', post?.blogBannerImage);
			formData.append('blogIconImage', post?.blogIconImage);
			...
			console.log(
				'🚀 ~ file: postSlices.js ~ line 28 ~ createPostAction ~ data',
				data
			);
			dispatch(resetPost());
			return data;
