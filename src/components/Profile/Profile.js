			...
			<section className="min-h-screen bg-white overflow-hidden">
				<div className="container px-4 mx-auto">
					{profileLoading ? (
						...
						<h2 className="text-red-800 text-2xl font-bold min-h-screen flex justify-center items-center">
										...
										<article>
											...
											<div className="flex justify-center place-items-start flex-wrap  md:mb-0">
												<div className="w-full md:w-1/3 px-4 mb-4 md:mb-0">
													<h1 className="text-center text-xl border-gray-500 mb-2 border-b-2 p-4">
