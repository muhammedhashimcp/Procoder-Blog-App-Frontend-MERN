...
const UpdateProfileForm = () => {
	...
	const { userDetails, isUpdated, appErr, loading, serverErr } = users;
			...
			<div className="container px-4 mx-auto">
				<div className="sm:mx-auto sm:w-full sm:max-w-md">
					<h3 className="mt-6 text-center text-3xl font-extrabold text-black">
						Hey {userDetails?.firstName}, do you want to update your
						profile?
					</h3>
					{/* Error */}
					{serverErr || appErr ? (
				...
				<div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
					<div className="bg-white py-8 px-4 shadow shadow-slate-600 sm:rounded-lg sm:px-10">
						<form
							className="space-y-6"
